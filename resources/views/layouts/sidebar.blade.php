<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if ((Auth::user()->kategori == 'MASTER' && Auth::user()->kategori != 'ADMIN') || Auth::user()->subdivisi == 'COMBEN')
            <!-- Comben, Payroll & PA Nav -->
            <li class="nav-item">
        ...
        @if ((Auth::user()->kategori == 'MASTER' && Auth::user()->kategori != 'ADMIN') || Auth::user()->subdivisi == 'REKRUT')
            <!-- Rekrutmen Nav -->
            <li class="nav-item">
        ...
        @if ((Auth::user()->kategori == 'MASTER' && Auth::user()->kategori != 'ADMIN') || Auth::user()->subdivisi == 'TND')
            <!-- Development Nav -->
            <li class="nav-item">
        ...
        @if ((Auth::user()->kategori == 'MASTER' && Auth::user()->kategori != 'ADMIN') || Auth::user()->subdivisi == 'IR')
            <!-- Industrial Relation Nav -->
            <li class="nav-item">
        ...
        <!-- Kamus Individu Nav -->
        <li class="nav-item">
            <a class="nav-link nav-link-load {{ Request::is('kamus') ? '' : 'collapsed' }}"
                href="{{ route('kamus') }}">
        ...
        @if (Auth::user()->kategori == 'MASTER')
            <!-- Users Nav -->
            <li class="nav-item">
                <a class="nav-link nav-link-load {{ Request::is('user') ? '' : 'collapsed' }}"
                    href="{{ route('user') }}">
