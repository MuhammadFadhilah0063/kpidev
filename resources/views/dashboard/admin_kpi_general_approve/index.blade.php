@extends('layouts.dashboard', ['pageTitle' => 'Data KPI General Approve Admin ' . $subdivisi])

@section('breadcrumb')
    <li class="breadcrumb-item active"><a>KPI General Approve Admin {{ $subdivisi }}</a></li>
@endsection
