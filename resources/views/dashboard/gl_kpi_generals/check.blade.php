@extends('layouts.dashboard', ['pageTitle' => 'Pemeriksaan KPI General Group Leader'])

@section('breadcrumb')
<li class="breadcrumb-item active"><a>KPI General Group Leader</a></li>
@endsection
                    ...
                    $(document).on('click', '.btnHapus', function() {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/gl-general/subdivisi/all/" + id,
                                    headers: {
                                        'X-CSRF-TOKEN': csrfToken
                                    },
                                    data: {
