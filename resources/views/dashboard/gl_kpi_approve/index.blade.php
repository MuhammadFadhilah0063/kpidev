@extends('layouts.dashboard', ['pageTitle' => 'Data KPI Approve Group Leader ' . $subdivisi])

@section('breadcrumb')
<li class="breadcrumb-item active"><a>KPI Approve Group Leader {{ $subdivisi }}</a></li>
@endsection
        ...
        $(document).ready(function() {
                    ...
                    var dataTable = $('#tableData').DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'kpi.periode.periode'
                            },
                            {
                                data: 'kpi.kamus.pointkpi'
                            },
                            {
                                data: 'kpi.pencapaian_sf'
                            },
                            {
                                data: 'kpi.kamus',
