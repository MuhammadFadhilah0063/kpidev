                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="form-group pt-3">
                        ...
                        <select class="form-control select3" name="kategori" id="kategori">
                            <option value="GROUP LEADER" selected>GROUP LEADER</option>
                            <option value="ADMIN">ADMIN</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group pt-3">
                        ...
                        <select class="form-control select3" name="subdivisi" id="subdivisi">
                            <option value="COMBEN" selected>COMBEN</option>
                            <option value="REKRUT">REKRUT</option>
                            <option value="TND">TND</option>
                            <option value="IR">IR</option>
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-9">
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="unit_target" id="unit_target" class="form-control" required
...
<script>
    $(document).ready(function() {
                ...
                $('#modal').on('hidden.bs.modal', function() {
                    ...
                    $('#subdivisi').val('COMBEN').trigger('change');
                    $('#kategori').val('GROUP LEADER').trigger('change');
