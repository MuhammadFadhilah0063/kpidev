                ...
                $(document).ready(function() {
                    ...
                    $(".btn-aksi").on("click", function(event) {
                        ...
                        if ($(".btn-aksi").text() == "EDIT") {
                            // Hapus invalid
                            clearInvalidInput(["periode", "id_kamus", "aktual_realisasi", "pencapaian_sf", "file",
                                "id_user",
                                "id_kamus"
                            ]);

                            // Mengambil nilai dari input
                            var formData = getValueInput(["periode", "id_kamus", "aktual_realisasi",
                                "pencapaian_sf", "subdivisi",
                                "id_user"
                            ]);
